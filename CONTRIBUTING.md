...
X's normal direction. A great way to
do this is via
...
- **Helping with open issues.** We have a lot of open issues for Ory X
...
git clone git@github.com:ory/ory/x.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/x.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory X
